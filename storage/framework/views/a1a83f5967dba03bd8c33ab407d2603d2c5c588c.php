                ...
                <form class="px-5 py-5" method="POST" action="<?php echo e(route('mahasiswa.update_profile')); ?>">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="password" id="password" disabled name="password"
                            ...
                            <?php else: ?>  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 <?php endif; ?>
                            ">
...
<?php /**PATH E:\xampp8\htdocs\jti-web\resources\views/mahasiswa/profile.blade.php ENDPATH**/ ?>