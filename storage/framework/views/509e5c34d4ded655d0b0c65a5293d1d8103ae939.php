    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="col-md-5" style="padding-left: 2rem; padding-bottom: 2rem">
                <button class="btn btn-primary" <?php echo e(Auth::guard('admin')->user()->role_id != 2 ? 'disabled' : ''); ?> data-bs-toggle="modal" data-bs-target="#tambahData">
                    Tambah Data
                </button>
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\xampp_8\htdocs\jti-web\resources\views/admin/data-admin.blade.php ENDPATH**/ ?>