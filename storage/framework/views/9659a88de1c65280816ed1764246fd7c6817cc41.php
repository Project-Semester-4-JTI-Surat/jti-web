...
<div>
    ...
    <div>
        ...
        <p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;line-height:107%;font-size:15px;font-family:"Calibri",sans-serif;'><span style='font-family:"Times New Roman",serif;'>&nbsp;</span></p>
        <p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;line-height:107%;font-size:15px;font-family:"Calibri",sans-serif;'><span style='font-family:"Times New Roman",serif;'>Konfirmasi ijin survey mahasiswa kami dapat disampaikan  pada <strong><?php echo e($surat->dosen->nama); ?></strong> dengan no Hp. <?php echo e($surat->dosen->no_hp); ?> selaku Dosen Bidang Tugas Mata Kuliah Program Studi D4 Teknik Informatika Politeknik Negeri Jember.</span></p>
    ...
    <div style="  margin:1rem 10rem 1rem 0; text-align:right; padding-right: 10%">
        <img src="data:image/png;base64, <?php echo base64_encode(QrCode::format('png')
...
<?php /**PATH C:\laragon\www\jti-surat\resources\views/template-surat/Internal/MK.blade.php ENDPATH**/ ?>