                ...
                <a href="<?php echo e(route('mahasiswa.detail_surat',$value->uuid)); ?>" class="group">
                    <div class=" cursor-pointer">
                        <div class="flex justify-between ">
                            ...
                            <span
                                class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 pt-1 rounded-full dark:bg-blue-900 dark:text-blue-300"><?php echo e($value->keterangan); ?></span>
                        </div>
