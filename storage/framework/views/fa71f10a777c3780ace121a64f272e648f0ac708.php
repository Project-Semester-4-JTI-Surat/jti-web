...
<body class="" id="main">
    <main class="px-20 mt-14">
        <h1 class="text-center font-bold text-2xl pb-10">Surat <?php echo e($surat->jenis_surat->keterangan); ?></h1>
        <div
            ...
            <form class="px-5 py-5">
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"><?php echo e($surat->alamat_mitra); ?></textarea>
                </div>
                <div class="mb-6">
                    <label for="confirm_password"
                        class="block mb-2 text-sm font-medium text-gray-900 ">Kebutuhan</label>
                    <textarea
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"><?php echo e($surat->kebutuhan); ?></textarea>
                </div>
                <div class="mb-6">
                    <label for="confirm_password"
                        class="block mb-2 text-sm font-medium text-gray-900 ">Keterangan</label>
                    <textarea
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"><?php echo e($surat->keterangan); ?></textarea>
                </div>
                <div class="mb-6">
                    <label for="confirm_password"
                        class="block mb-2 text-sm font-medium text-gray-900 ">Status</label>
                    <textarea
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"><?php echo e($surat->status->keterangan); ?> <?php echo e($surat->status->keterangan == 'Ditolak' ? '- '.$surat->alasan_penolakan : ''); ?>
                ...
                <?php if($surat->softfile_scan != ''): ?>
                    <div class="mb-6">
                        ...
                        <a href="<?php echo e(route('downloadSoftfile',['prodi'=>$prodi,'file'=>$surat->softfile_scan])); ?>"
                ...
                <div>
                    <?php $__currentLoopData = $anggota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <h1 class=" py-2 text-lg font-bold">Anggota <?php echo e($key + 1); ?></h1>
