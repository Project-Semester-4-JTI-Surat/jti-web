...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function loadTable() {
            var url = "<?php echo e(route('admin.data-admin.index')); ?>";
            $('#tableAdmin').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: 'aksi',
                        name: 'aksi',
                        visible: <?php echo e(Auth::guard('admin')->user()->role_id == 2 ? 'true' : 'false'); ?>
        ...
        $('#formTambahData').submit(function(e) {
            ...
            if (form.valid()) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.data-admin.insert')); ?>",
                    type: 'POST',
                    data: formData,
                    cache: false,
                    contentType: false,
        ...
        function edit(id) {
            var url = "<?php echo e(route('admin.data-admin.edit', ':id')); ?>"
            var updateUrl = "<?php echo e(route('admin.data-admin.update', ':id')); ?>"
            $.ajax({
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\jti-surat\resources\views/admin/data-admin.blade.php ENDPATH**/ ?>