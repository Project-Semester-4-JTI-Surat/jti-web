...
<div>
    ...
    <div>
        ...
        <p style="text-align:justify; line-height:115%">
            <strong><?php echo e($surat->nama_mitra); ?></strong>
        </p>
        <p style="text-align:justify; line-height:115%">
        ...
        <p style="text-align:justify">
            ...
            Jurusan Teknologi Informasi <strong>Program Studi <?php echo e($surat->prodi->note); ?> </strong>guna melaksanakan Magang di
            perusahaan yang Bapak/Ibu Pimpin dari tanggal <strong><?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d',  $surat->tanggal_pelaksanaan)->translatedFormat('d F Y')); ?> sampai <?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d',  $surat->tanggal_selesai)->translatedFormat('d F Y')); ?></strong> dengan &#xa0;materi
        ...
        <p style="text-align:justify">
            Konfirmasi kesediaan Bapak/Ibu untuk menerima Program Magang mahasiswa kami dapat disampaikan pada <strong><?php echo e($surat->koordinator->nama); ?></strong> dengan&#xa0; No. Hp. <?php echo e($surat->koordinator->no_hp); ?> selaku Koordinator Bidang Magang
            Program Studi <?php echo e($surat->prodi->note); ?> Politeknik Negeri Jember.
        </p>
        <p style="text-align:justify; font-size:8pt">
            &#xa0;
        </p>
...
<?php /**PATH C:\laragon\www\jti-surat\resources\views/template-surat/Eksternal/PK.blade.php ENDPATH**/ ?>