...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        function reset_password(id){
            var url = "<?php echo e(route('admin.mahasiswa.reset_password',['id'=>':id'])); ?>";
            // console.log(data);
            swal({
                title: "Anda yakin?",
        ...
        function delete_data(id){
            var url = "<?php echo e(route('admin.mahasiswa.hapus',['id'=>':id'])); ?>";
            // console.log(data);
            swal({
                title: "Anda yakin?",
        ...
        function loadDataMahasiswa() {
            var url = "<?php echo e(route('admin.mahasiswa.index')); ?>";
            $('#tableMhs').DataTable({
                searching: true,
                paging: true,
                destroy: true,
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\jti-surat\resources\views/admin/mahasiswa.blade.php ENDPATH**/ ?>