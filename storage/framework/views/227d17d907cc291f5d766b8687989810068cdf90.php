<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboard -->
        <li class="menu-item <?php echo e(Route::currentRouteName() == 'admin.dashboard' ? 'active' : ''); ?>" href="<?php echo e(route('admin.dashboard')); ?>">
       ...
       <li class="menu-item <?php echo e(Route::currentRouteName() == 'admin.dosen.index' ? 'active' : ''); ?>">
        ...
        </li><li class="menu-item <?php echo e(Route::currentRouteName() == 'admin.data-admin.index' ? 'active' : ''); ?>">
...
<!-- / Menu -->
<?php /**PATH D:\Xampp_new\xampp_8\htdocs\jti-web\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>