<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboard -->
        <li class="menu-item {{ Route::currentRouteName() == 'admin.dashboard' ? 'active' : ''}}" href="{{route('admin.dashboard')}}">
        ...
        @endphp
            ...
            @foreach($status as $key => $value)
                <li class="menu-item">
                    <a href="{{ route('admin.surat.index',['id'=>$value->id]) }}" class="menu-link">
       ...
       <li class="menu-item {{ Route::currentRouteName() == 'admin.dosen.index' ? 'active' : ''}}">
        ...
        </li><li class="menu-item {{ Route::currentRouteName() == 'admin.data-admin.index' ? 'active' : ''}}">
