                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                ...
                                <img src="{{ asset('img/illustrations/login.png') }}" alt="login form" class="img-fluid"
                                    style="border-radius: 1rem 0 0 1rem;" />
                            </div>
                            <div class="col-md-6 col-lg-7 d-flex align-items-center" id="form">
                                <div class="card-body p-4 p-lg-5 text-black">

                                    <form id="formAuthentication" action="{{ route('mahasiswa.login_process') }}"
                                        method="POST">
                                        @csrf
                                        ...
                                        <p class="mb-5 pb-lg-2">Belum mendaftar? <a
                                                href="{{ route('mahasiswa.register') }}" style="color: #393f81;">Daftar
                                                disini</a> atau <a style="color: #393f81;" href="{{route('mahasiswa.forgot_password')}}">lupa password</a></p>
                                    </form>
