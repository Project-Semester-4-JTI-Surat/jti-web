...
<body class="dark:bg-gray-900" id="main">
    ...
    <main class="px-20 mt-14">
        <h1 class="text-center font-bold dark:text-white text-2xl pb-10">Surat {{ $surat->jenis_surat->keterangan }}</h1>
        <div
            ...
            <form class="px-5 py-5">
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $surat->alamat_mitra }}</textarea>
                </div>
                <div class="mb-6">
                    <label for="confirm_password"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kebutuhan</label>
                    <textarea
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $surat->kebutuhan }}</textarea>
                </div>
                <div class="mb-6">
                    <label for="confirm_password"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Keterangan</label>
                    <textarea
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $surat->keterangan }}</textarea>
                </div>
                <div class="mb-6">
                    <label for="confirm_password"
                ...
                <div>
                    @foreach ($anggota as $key => $value)
                        <h1 class="dark:text-white py-2 text-lg font-bold">Anggota {{ $key + 1 }}</h1>
